...
#### This project tries to find the similarities between dishes and cuisines using the given dataset and we will plot various diagrams to show the similarities. Thus, we have extracted three problems based upon the dataset which are:
